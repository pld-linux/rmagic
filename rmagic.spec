...
web site statistics software. Report Magic uses the statistics
generated by Analog and formatting options set by you to make
readable, presentable reports of your Web site data.

%description -l pl
Report Magic dla Analoga to dodatek formatuj±cy dla programu
Analog s³u¿±cego do statystyk serwisów WWW. Report Magic u¿ywa
statystyk wygenerowanych przez Analoga oraz ustawionych opcji do
stworzenia czytelnych, nadaj±cych siê do prezentacji raportów z
danych serwisu WWW.
